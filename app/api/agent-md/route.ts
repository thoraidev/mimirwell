 ...
 * Any agent can fetch this URL and have everything needed to use MimirWell.
 */

import { NextResponse } from "next/server";

const AGENT_MD = `# MimirWell — Agent Integration Guide
...
The human owner calls \`revoke(agentAddress)\` on this contract from their wallet.
...
- Revoke ThorAI's access with your MetaMask
